...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook: any }> = (props) => {
  ...
  async function decreaseQuantity() {
    const url = `${process.env.REACT_APP_BASE_URL}/admin/secure/decrease/book/quantity/?bookId=${props.book?.id}`;
    const requestOptions = {
      method: 'PUT',
      headers: {
        Authorization: authorizationString,
  ...
  async function deleteBook() {
    const url = `${process.env.REACT_APP_BASE_URL}/admin/secure/delete/book/?bookId=${props.book?.id}`;
    const requestOptions = {
      method: 'DELETE',
      headers: {
        Authorization: authorizationString,
